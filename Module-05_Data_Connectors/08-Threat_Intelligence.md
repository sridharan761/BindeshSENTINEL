# MISP Threat Intelligence Platform to Microsoft Sentinel Integration

## Prerequisites

- Create a Ubuntu VM.
- Being this is owned by the SecOps team, the VM lives within my SecOps subscription in Azure.

## Install and Configure the MISP TI Platform
